...
class AsrtApiResponse:
    ...
    '''
    def __init__(self, status_code, status_message='', result = AsrtApiResponseResult):
...
def recognition_post(level):
    ...
    try:
        if level == 'speech':
            ...
            json_data.result = AsrtApiResponseResult(result)
            buffer = json_data.to_json()
            print('output:', buffer)
            return Response(buffer, mimetype='application/json')
        elif level == 'language':
            ...
            json_data.result = AsrtApiResponseResult(None, result)
            buffer = json_data.to_json()
            print('output:', buffer)
            return Response(buffer, mimetype='application/json')
        elif level == 'all':
            ...
            json_data.result = AsrtApiResponseResult(result_speech, result)
            buffer = json_data.to_json()
